...
/* Розробіть алгоритм в якому використовується лінійний алгоритм
підрахунку пар з нульовою сумою після сортування цього масиві
(замість лінійно-логарифмічного алгоритму на основі бінарного
пошуку) */
